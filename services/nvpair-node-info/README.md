...
- **Not inference-ready when integrated.** An integrated Intel GPU row carries `inference_ready:false`: no engine PAIR runs on Linux drives it. A discrete Arc card makes no such claim either way.
